...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,3,3,2], nums2 = [2,1,3,4], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [4,2,3,1,1], nums2 = [7,5,10,9,6], k = 1
