...
<pre style="position: relative;"><strong>Input:</strong> s = "bab", t = "aba"
...
<pre style="position: relative;"><strong>Input:</strong> s = "leetcode", t = "practice"
...
<pre style="position: relative;"><strong>Input:</strong> s = "anagram", t = "mangaar"
