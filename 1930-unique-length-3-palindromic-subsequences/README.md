...
<pre style="position: relative;"><strong>Input:</strong> s = "aabca"
...
<pre style="position: relative;"><strong>Input:</strong> s = "adc"
...
<pre style="position: relative;"><strong>Input:</strong> s = "bbcbaba"
