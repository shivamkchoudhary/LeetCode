...
<pre style="position: relative;"><strong>Input:</strong> steps = 3, arrLen = 2
...
<pre style="position: relative;"><strong>Input:</strong> steps = 2, arrLen = 4
...
<pre style="position: relative;"><strong>Input:</strong> steps = 4, arrLen = 2
