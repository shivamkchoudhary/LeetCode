...
<pre style="position: relative;"><strong>Input:</strong> pushed = [1,2,3,4,5], popped = [4,5,3,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> pushed = [1,2,3,4,5], popped = [4,3,5,1,2]
