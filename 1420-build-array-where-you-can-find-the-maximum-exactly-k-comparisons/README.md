...
<pre style="position: relative;"><strong>Input:</strong> n = 2, m = 3, k = 1
...
<pre style="position: relative;"><strong>Input:</strong> n = 5, m = 2, k = 3
...
<pre style="position: relative;"><strong>Input:</strong> n = 9, m = 1, k = 1
