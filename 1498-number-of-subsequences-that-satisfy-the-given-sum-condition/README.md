...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,5,6,7], target = 9
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,3,6,8], target = 10
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,3,3,4,6,7], target = 12
