...
<pre style="position: relative;"><strong>Input:</strong> s = "1000", k = 10000
...
<pre style="position: relative;"><strong>Input:</strong> s = "1000", k = 10
...
<pre style="position: relative;"><strong>Input:</strong> s = "1317", k = 2000
