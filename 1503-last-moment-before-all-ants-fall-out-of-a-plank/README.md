...
<pre style="position: relative;"><strong>Input:</strong> n = 4, left = [4,3], right = [0,1]
...
<pre style="position: relative;"><strong>Input:</strong> n = 7, left = [], right = [0,1,2,3,4,5,6,7]
...
<pre style="position: relative;"><strong>Input:</strong> n = 7, left = [0,1,2,3,4,5,6,7], right = []
<strong>Output:</strong> 7
