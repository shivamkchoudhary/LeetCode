...
<pre style="position: relative;"><strong>Input:</strong> s1 = "parker", s2 = "morris", baseStr = "parser"
...
<pre style="position: relative;"><strong>Input:</strong> s1 = "hello", s2 = "world", baseStr = "hold"
...
<pre style="position: relative;"><strong>Input:</strong> s1 = "leetcode", s2 = "programs", baseStr = "sourcecode"
