...
<pre style="position: relative;"><strong>Input:</strong> arr = [2,2,1,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> arr = [100,1,1000]
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3,4,5]
