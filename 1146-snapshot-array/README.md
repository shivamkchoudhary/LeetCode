...
<pre style="position: relative;"><strong>Input:</strong> ["SnapshotArray","set","snap","set","get"]
[[3],[0,5],[],[0,6],[0,0]]
...
snapshotArr.set(0,6);
snapshotArr.get(0,0);  // Get the value of array[0] with snap_id = 0, return 5<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
