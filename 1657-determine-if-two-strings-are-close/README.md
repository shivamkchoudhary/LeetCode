...
<pre style="position: relative;"><strong>Input:</strong> word1 = "abc", word2 = "bca"
...
<pre style="position: relative;"><strong>Input:</strong> word1 = "a", word2 = "aa"
...
<pre style="position: relative;"><strong>Input:</strong> word1 = "cabbba", word2 = "abbccc"
<strong>Output:</strong> true
