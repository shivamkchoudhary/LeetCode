...
<pre style="position: relative;"><strong>Input:</strong> jobDifficulty = [6,5,4,3,2,1], d = 2
...
<pre style="position: relative;"><strong>Input:</strong> jobDifficulty = [9,9,9], d = 4
...
<pre style="position: relative;"><strong>Input:</strong> jobDifficulty = [1,1,1], d = 3
