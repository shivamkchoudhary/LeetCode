...
<pre style="position: relative;"><strong>Input:</strong> poured = 1, query_row = 1, query_glass = 1
...
<pre style="position: relative;"><strong>Input:</strong> poured = 2, query_row = 1, query_glass = 1
...
<pre style="position: relative;"><strong>Input:</strong> poured = 100000009, query_row = 33, query_glass = 17
