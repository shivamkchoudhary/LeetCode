...
<pre style="position: relative;"><strong>Input:</strong> dist = [1,3,2], hour = 6
...
<pre style="position: relative;"><strong>Input:</strong> dist = [1,3,2], hour = 2.7
...
<pre style="position: relative;"><strong>Input:</strong> dist = [1,3,2], hour = 1.9
<strong>Output:</strong> -1
